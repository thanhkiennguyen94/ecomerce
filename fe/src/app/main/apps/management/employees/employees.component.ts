...
import { aioTableData, aioTableLabels } from "./aio-table-data";
...
import { ManagementEmployeesService } from "./employees.service";
...
export class ManagementEmployeesComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private employeeService: ManagementEmployeesService
  ) {}
