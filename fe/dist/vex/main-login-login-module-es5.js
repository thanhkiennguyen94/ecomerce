(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-login-login-module"], {
    ...
    /***/
    function PAky(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      LoginModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineNgModule"]({
        type: LoginModule
      });
      LoginModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes), _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_7__["MatSnackBarModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_8__["IconModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_9__["MatTooltipModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_11__["MatCheckboxModule"]]]
      });
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵsetNgModuleScope"](LoginModule, {
          ...
          imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_7__["MatSnackBarModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_8__["IconModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_9__["MatTooltipModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_11__["MatCheckboxModule"]]
        });
      })();
      /***/
    ...
    function dNgK(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatSnackBarContainer = /*#__PURE__*/function (_angular_cdk_portal__) {
        ...
        snackBarConfig) {
          ...
          _this6.snackBarConfig = snackBarConfig;
          /** The number of milliseconds to wait before announcing the snack bar's content. */

          _this6._announceDelay = 150;
          /** Whether the component has been destroyed. */

          _this6._destroyed = false;
          /** Subject for notifying that the snack bar has announced to screen readers. */

          _this6._onAnnounce = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
          /** Subject for notifying that the snack bar has exited from view. */

          _this6._onExit = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
          /** Subject for notifying that the snack bar has finished entering the view. */

          _this6._onEnter = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
          /** The state of the snack bar animations. */

          _this6._animationState = 'void';
          /**
          ...
          _this6.attachDomPortal = function (portal) {
            _this6._assertNotAttached();

            _this6._applySnackBarClasses();
          ...
          if (_this6._platform.FIREFOX) {
            if (_this6._live === 'polite') {
              _this6._role = 'status';
            }

            if (_this6._live === 'assertive') {
              _this6._role = 'alert';
            }
          }
        ...
        _createClass(MatSnackBarContainer, [{
          ...
          value: function _screenReaderAnnounce() {
            ...
            if (!this._announceTimeoutId) {
              this._ngZone.runOutsideAngular(function () {
                _this8._announceTimeoutId = setTimeout(function () {
                  var inertElement = _this8._elementRef.nativeElement.querySelector('[aria-hidden]');

                  var liveElement = _this8._elementRef.nativeElement.querySelector('[aria-live]');
                  ...
                  if (inertElement && liveElement) {
                    ...
                    if (_this8._platform.isBrowser && document.activeElement instanceof HTMLElement && inertElement.contains(document.activeElement)) {
                    ...
                    _this8._onAnnounce.next();

                    _this8._onAnnounce.complete();
                  }
                }, _this8._announceDelay);
              });
            }
          }
        }]);
        ...
        _createClass(MatSnackBar, [{
          ...
          value: function _attach(content, userConfig) {
            ...
            this._breakpointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_11__["Breakpoints"].HandsetPortrait).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(overlayRef.detachments())).subscribe(function (state) {
              ...
              state.matches ? classList.add(_this9.handsetCssClass) : classList.remove(_this9.handsetCssClass);
            });

            if (config.announcementMessage) {
              // Wait until the snack bar contents have been announced then deliver this message.
              container._onAnnounce.subscribe(function () {
                _this9._live.announce(config.announcementMessage, config.politeness);
              });
            }
          ...
          value: function _animateSnackBar(snackBarRef, config) {
            ...
            snackBarRef.afterDismissed().subscribe(function () {
              ...
              if (_this10._openedSnackBarRef == snackBarRef) {
                _this10._openedSnackBarRef = null;
              }
    ...
    /***/
    function ogB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(router, fb, cd) {
...
//# sourceMappingURL=main-login-login-module-es5.js.map